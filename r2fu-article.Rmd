...
(Add table w/ sociodemographics here.)

\begin{table}

\caption{\label{tab:demdata}Vid förmätningstillfället insamlad sociodemografisk data om deltagarna.}
\centering
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{12em}>{\centering\arraybackslash}p{6em}>{\centering\arraybackslash}p{6em}>{\centering\arraybackslash}p{6em}>{\centering\arraybackslash}p{6em}}
\toprule
  & Väntelista (n = 68) & Självhjälp (n = 67) & Behandlarstöd (n = 70) & Sammanlagt (n = 205)\\
\midrule
\addlinespace[0.3em]
\multicolumn{5}{l}{Ålder (år)}\\
\hspace{1em}M (SD) & 41 (8) & 41 (9) & 44 (10) & 42 (9)\\
\midrule
\addlinespace[0.3em]
\multicolumn{5}{l}{Kön (\%)}\\
\hspace{1em}Kvinna & 91 & 79 & 93 & 88\\
\midrule
\addlinespace[0.3em]
\multicolumn{5}{l}{Civilstånd (\%)}\\
\hspace{1em}Singel & 37 & 36 & 29 & 34\\
\hspace{1em}Sambo & 19 & 25 & 17 & 20\\
\hspace{1em}Gift & 37 & 28 & 49 & 38\\
\hspace{1em}Annat & 7 & 10 & 6 & 8\\
\midrule
\addlinespace[0.3em]
\multicolumn{5}{l}{Utbildning (\%)}\\
\hspace{1em}Annan utbildning & 3 & 1 & 1 & 2\\
\hspace{1em}Folkskola/grundskola & 1 & 0 & 0 & 0\\
\hspace{1em}Gymnasium & 10 & 9 & 7 & 9\\
\hspace{1em}Yrkesutbildning & 7 & 4 & 7 & 6\\
\hspace{1em}Pågående högre utbildning & 7 & 15 & 10 & 11\\
\hspace{1em}Avslutad högre utbildning & 71 & 70 & 74 & 72\\
\midrule
\addlinespace[0.3em]
\multicolumn{5}{l}{Sysselsättning (\%)}\\
\hspace{1em}Annan sysselsättning & 9 & 6 & 7 & 7\\
\hspace{1em}Studerande & 7 & 12 & 6 & 8\\
\hspace{1em}Arbetande & 74 & 76 & 76 & 75\\
\hspace{1em}Arbetslös & 4 & 4 & 0 & 3\\
\hspace{1em}Pensionär & 0 & 0 & 4 & 1\\
\hspace{1em}Föräldraledig & 0 & 0 & 4 & 1\\
\hspace{1em}Sjukskriven & 6 & 1 & 3 & 3\\
\midrule
\addlinespace[0.3em]
\multicolumn{5}{l}{Användning psykofarmaka (\%)}\\
\hspace{1em}Nej & 76 & 70 & 67 & 71\\
\hspace{1em}Ja, tidigare & 7 & 9 & 17 & 11\\
\hspace{1em}Ja, pågående & 16 & 21 & 16 & 18\\
\midrule
\addlinespace[0.3em]
\multicolumn{5}{l}{Tidigare psykologisk behandling (\%)}\\
\hspace{1em}Nej & 38 & 40 & 39 & 39\\
\hspace{1em}Ja & 62 & 60 & 61 & 61\\
\bottomrule
\end{tabular}
\end{table}
