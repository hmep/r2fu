...
The large between-group effects on assertiveness measured with AAA-S Adaptive and the RAS at Follow-up in the Unguided self-help condition, `r report.text2(aaas_ad.out, paste(xT3,xG3,"-",xT4,xG1), -1,"effshort")` and `r report.text2(rathus.out, paste(xT3,xG3,"-",xT4,xG1), -1,"effshort")`, 
<!-- with $22$\% and $31$\% clinically improved,  -->
and insignificantly larger effects 
<!-- and $26$\% and $36$\% clinically improved, respectively,  -->
in the Guided group, are comparable to those found in clinical trials of iCBT interventions for other trans-diagnostic behavioral targets. Benchmarking against procrastination [$d$ = $.50$--$.69$ and $24$--$36$\% clinically improved in an unguided group, and $d$ = $.70$--$.81$ and $31$--$40$\% clinically improved in a guided group\; @Rozental2015], and perfectionism [$d$ = $.68$--$1.00$, with $45$\% of participants clinically improved in a guided group\; @Rozental2017], these results indicate that the assertiveness construct can be used successfully as a target in behavior therapy with various clinical presentations, helping participants appreciate and report changes in healthy assertion levels in their daily lives.
