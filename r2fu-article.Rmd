...
xpr <- function(x) {
  paste("$p$",
        ifelse(x < 0.001, "< $0.00$", ifelse(x < 0.05, paste("=",prettyNum(x,digits=1,decimal.mark=".")), ifelse(x > 0.05, "DO NOT REPORT", "= $0.05$")))
  )
}

xpr_special <- function(x) {
  paste("$p$",
        ifelse(x < 0.001, "< 0,00", ifelse(x < 0.05, paste("=",prettyNum(x,digits=1,decimal.mark=",")), ifelse(x > 0.05, paste("=",prettyNum(x,digits=1,decimal.mark=".")), "= 0.05")))
  )
}
...
comparison <- linebreak(c(
  ...
  "Self-help at 1-year Follow-up vs. Waitlist at \\dag",
  "Guided self-help at Post vs. Waitlist at Post",
  "Guided self-help at 1-year Follow-up vs. Waitlist at Post",
  "Guided self-help at 1-year Follow-up vs. Waitlist at \\dag",
