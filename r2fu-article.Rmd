...
A linear mixed-effects model was fitted to estimate fixed and random effects of group, time, and group-time interaction, using an unstructured covariance pattern, and the Kenward-Roger approximation to estimate denominator degrees of freedom. Post-hoc comparisons were performed using T-tests with Bonferroni-corrected p-values. The proportions of participants showing reliable change and reaching clinical significance were determined in accordance with  @Jacobson1991, using the 'c' definition to select the cutoff value. (Eller 'a' för att vara maximalt konservativ?)
