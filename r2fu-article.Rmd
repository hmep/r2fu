...
clinsig.table <- rbind(
  cbind( # Kruskal-Wallis chi-squared = 7.9198, df = 2, p-value = 0.02
    xclinsigcategories,
  ...
  cbind( # Kruskal-Wallis chi-squared = 0.1847, df = 2, p-value = 0.91
    xclinsigcategories,
  ...
  cbind( # Kruskal-Wallis chi-squared = 21.5053, df = 2, p-value = 0
    xclinsigcategories,
  ...
  cbind( # Kruskal-Wallis chi-squared = 11.8735, df = 2, p-value = 0
    xclinsigcategories,
  ...
  cbind( # Kruskal-Wallis chi-squared = 5.123, df = 2, p-value = 0.08
    xclinsigcategories,
  ...
  cbind( # Kruskal-Wallis chi-squared = 14.1971, df = 2, p-value = 0
    xclinsigcategories,
