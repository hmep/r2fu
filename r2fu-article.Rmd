...
anova(aaas_ad.lmer,type=3) # Significant interaction, calls for post-hoc analysis
...
anova(aaas_ag.lmer,type=3) # No significant interaction
...
anova(rathus.lmer,type=3) # Significant interaction, calls for post-hoc analysis
...
anova(lsas_sum.lmer,type=3) # Significant interaction, calls for post-hoc analysis
...
anova(phq_sum.lmer,type=3) # Significant interaction, calls for post-hoc analysis
...
anova(gad_sum.lmer,type=3) # No significant interaction
...
anova(well.lmer,type=3) # Significant interaction, calls for post-hoc analysis
