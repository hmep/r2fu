...
aaas_ad.emm.by.time <- emmeans(aaas_ad.lmer, ~ group | time, adjust="bonferroni")
aaas_ad.emmpairs.by.group <- pairs(aaas_ad.emm.by.group)
aaas_ad.emmpairs.by.time <- pairs(aaas_ad.emm.by.time)
aaas_ad.sd <- sqrt(6.7432^2 + 4.7000^2) # VarCorr(aaas_ad.lmer)
aaas_ad.eff.by.group <- eff_size(aaas_ad.emm.by.group[effsel.group], sigma = aaas_ad.sd, edf = df.residual(aaas_ad.lmer))
aaas_ad.eff.by.time <- eff_size(aaas_ad.emm.by.time[effsel.time], sigma = aaas_ad.sd, edf = df.residual(aaas_ad.lmer))
...
aaas_ag.emmpairs.by.group <- pairs(aaas_ag.emm.by.group)
aaas_ag.emmpairs.by.time <- pairs(aaas_ag.emm.by.time)
aaas_ag.sd <- sqrt(5.8868^2 + 3.4881^2) # VarCorr(aaas_ag.lmer)
aaas_ag.eff.by.group <- eff_size(aaas_ag.emm.by.group[effsel.group], sigma = aaas_ag.sd, edf = df.residual(aaas_ag.lmer))
aaas_ag.eff.by.time <- eff_size(aaas_ag.emm.by.time[effsel.time], sigma = aaas_ag.sd, edf = df.residual(aaas_ag.lmer))
...
rathus.emmpairs.by.group <- pairs(rathus.emm.by.group)
rathus.emmpairs.by.time <- pairs(rathus.emm.by.time)
rathus.sd <- sqrt(19.750^2 + 12.553^2) # VarCorr(rathus.lmer)
rathus.eff.by.group <- eff_size(rathus.emm.by.group[effsel.group], sigma = rathus.sd, edf = df.residual(rathus.lmer))
rathus.eff.by.time <- eff_size(rathus.emm.by.time[effsel.time], sigma = rathus.sd, edf = df.residual(rathus.lmer))

# LSAS-SR
lsas_sum.emm.by.group <- emmeans(lsas_sum.lmer, ~ time | group, adjust="bonferroni")
lsas_sum.emm.by.time <- emmeans(lsas_sum.lmer, ~ group | time, adjust="bonferroni")
lsas_sum.emmpairs.by.group <- pairs(lsas_sum.emm.by.group)
lsas_sum.emmpairs.by.time <- pairs(lsas_sum.emm.by.time)
lsas_sum.sd <- sqrt(18.6303^2 + 9.1658^2) # VarCorr(lsas_sum.lmer)
lsas_sum.eff.by.group <- eff_size(lsas_sum.emm.by.group[effsel.group], sigma = lsas_sum.sd, edf = df.residual(lsas_sum.lmer))
lsas_sum.eff.by.time <- eff_size(lsas_sum.emm.by.time[effsel.time], sigma = lsas_sum.sd, edf = df.residual(lsas_sum.lmer))

# GAD-7
gad_sum.emm.by.group <- emmeans(gad_sum.lmer, ~ time | group, adjust="bonferroni")
gad_sum.emm.by.time <- emmeans(gad_sum.lmer, ~ group | time, adjust="bonferroni")
gad_sum.emmpairs.by.group <- pairs(gad_sum.emm.by.group)
gad_sum.emmpairs.by.time <- pairs(gad_sum.emm.by.time)
gad_sum.sd <- sqrt(3.0683^2 + 2.8042^2) # VarCorr(gad_sum.lmer)
gad_sum.eff.by.group <- eff_size(gad_sum.emm.by.group[effsel.group], sigma = gad_sum.sd, edf = df.residual(gad_sum.lmer))
gad_sum.eff.by.time <- eff_size(gad_sum.emm.by.time[effsel.time], sigma = gad_sum.sd, edf = df.residual(gad_sum.lmer))

# PHQ-9
phq_sum.emm.by.group <- emmeans(phq_sum.lmer, ~ time | group, adjust="bonferroni")
phq_sum.emm.by.time <- emmeans(phq_sum.lmer, ~ group | time, adjust="bonferroni")
phq_sum.emmpairs.by.group <- pairs(phq_sum.emm.by.group)
phq_sum.emmpairs.by.time <- pairs(phq_sum.emm.by.time)
phq_sum.sd <- sqrt(2.9232^2 + 3.0568^2) # VarCorr(phq_sum.lmer)
phq_sum.eff.by.group <- eff_size(phq_sum.emm.by.group[effsel.group], sigma = phq_sum.sd, edf = df.residual(phq_sum.lmer))
phq_sum.eff.by.time <- eff_size(phq_sum.emm.by.time[effsel.time], sigma = phq_sum.sd, edf = df.residual(phq_sum.lmer))

# Välmåendeskalan
well.emm.by.group <- emmeans(well.lmer, ~ time | group, adjust="bonferroni")
well.emm.by.time <- emmeans(well.lmer, ~ group | time, adjust="bonferroni")
well.emmpairs.by.group <- pairs(well.emm.by.group)
well.emmpairs.by.group <- pairs(well.emm.by.time)
well.sd <- sqrt(8.6916^2 + 7.6614^2) # VarCorr(well.lmer)
well.eff.by.group <- eff_size(well.emm.by.group[effsel.group], sigma = well.sd, edf = df.residual(well.lmer))
well.eff.by.time <- eff_size(well.emm.by.time[effsel.time], sigma = well.sd, edf = df.residual(well.lmer))
