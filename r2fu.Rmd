...
date: "220103"
lang: en-US
bibliography: ["packages.bib", "KSH.bib"]
link-citations: yes
output:
  beamer_presentation: 
    colortheme: seahorse
...
<!-- Drawing on the definition from @alberti1974your this study investigates how promoting assertive actions that both respect personal rights and rights of others can alleviated psychological suffering. Respect Squared combines theories from 1st, 2nd and 3rd wave behavioral therapies to help activate assertive behaviors in anxiety-provoking contexts.  -->


<!-- Assertive self-expression is 'direct, firm, positive, and when necessary, persistent, action intended to promote equality in person-to-person relationships. Assertiveness enables us to act in our own best interests, to stand up for ourselves without undue anxiety, to exercise personal rights without denying the rights of others, and to express our feelings and needs (affection, love, friendship, disappointment, annoyance, anger, regret, sorrow) honestly and comfortably. @alberti1974your  -->

<!-- https://books.google.se/books?id=iPAhDgAAQBAJ&pg=PT85&hl=sv&source=gbs_selected_pages&cad=2#v=onepage&q&f=false -->

## Brief history of assertiveness training

Assertiveness training goes back to the very first behvioral interventions, such as @salter1949conditioned and @Wolpe1966. In the 1970's, the concept was popularized in self-help books such as @alberti1974your, @smith1975say, and @fensterheim1975don. @LINEHAN1979 was a foundation for what later became Dialectical Behavior Therapy (DBT), in which assertiveness skills training is an integral part. It has implicitly been a target in treatments for anxiety disorders (such as social anxiety disorder) ever since.
...
The aim of this study is to investigate the effectiveness of a newly developed CBT  internet-delivered treatment program targeting assertiveness. The program builds on the freely available online resource *Assert Yourself* [@michel2008], published by Centre for Clinical Interventions (CCI), part of the government of Western Australia in Australia. 

Respect Squared combines theories from 1st, 2nd and 3rd wave behavioral therapies to help activate assertive behaviors in anxiety-provoking contexts. 
