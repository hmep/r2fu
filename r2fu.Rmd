...
packages <- c("lme4", "jtools", "broom.mixed", "readxl", "writexl", "tidyr", "jtools", "lattice", "modelr", "ggeffects", "emmeans", "patchwork", "outliers", "performance")
...
```{r primary, results="asis", fig.width = 13, fig.asp = 0.75}
