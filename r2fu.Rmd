...
colnames(demdata.tabell) <- c(
  ...
  paste(xG1," (n = ",ll1,")",sep=""),
  paste(xG2," (n = ",ll2,")",sep=""),
  paste("Sammanlagt (n = ",length(r2fu.wide.data[,1]),")",sep="")
)
...
knitr::kable(demdata.tabell, format="latex", booktabs=T, caption = "(ref:dem)", align="ccc") %>%
  ...
  pack_rows("Use of psychogropic drugs (%)", 20, 22, bold = F) %>%
