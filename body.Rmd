...
The analysis of clinical change revealed that large majorities in all groups at both the post and follow-up time points remained unchanged. This is expected for a non-clinical sample, for which baseline measurement scores were already well on the "healthy" side of cutoff values.

## Limitations and future directions

The guided and un-guided conditions produced similar mean levels across measures of assertiveness as well as measures of psychiatric disorders, possibly indicating a ceiling effect of the self-help material with a non-clinical sample. Future replications could investigate the role of therapist contributions and its interaction with participant factors for different diagnostic populations in more detail, preferably employing a larger number of therapists, and model therapist factors in the analysis. Also, such a study could also investigate and compare the ratio of benefits and costs of the support component for different diagnostic subgroups.
