...
```{bash flowchartgen, include = F, eval = T}
...
xcolnames <-
  c(
    ...
    paste0("\\parbox{8em}{\\hfil{}",xT1,"--",xT3,"\\hfil{}}"),
    paste0("\\parbox{8em}{\\hfil{}",xT1,"--",xT4text,"\\hfil{}}"),
    paste0("\\parbox{8em}{\\hfil{}",xT1,"--",xT3,"\\hfil{}}"),
    paste0("\\parbox{8em}{\\hfil{}",xT1,"--",xT4text,"\\hfil{}}")
  )
