...
This study aimed to conduct a randomized controlled trial (RCT) on the effects of an eight-week iCBT intervention for maladaptive levels of assertiveness, Respekt^2^ (Respect Squared), based on the @michel2008 modules. We tested the effects on measures of anxiety and depression and also the difference between guided and unguided iCBT against the control group (three-armed trial). 
