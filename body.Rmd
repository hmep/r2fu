...
knitr::kable(
  ...
  column_spec(c(2:7), width = c("10.5em","11em","10.5em","10.5em","10.5em","10.5em")) %>% # 11.5em
  add_header_above(
    c(
      " ",
...
<!-- 2do: Add in reliable harm for Waitlist with regards to Välmåendeskalan, compared to the Guided condition. -->
...
<!-- 2do: Give rationale for moving Rathus from secondary to primary outcome measure. -->

<!-- 2do: Include BBQ outcomes. -->

<!-- 2do: Double-check analysis of clinical change for aggressive assertiveness. Is higher or lower desirable for this sample? Compare baseline levels with norms. Check @Thompson2011 -->
